...
//post element with react 
export const CreatePost = () => {
  //gating user from redux store
  ...
  const postHandler = async (e) => {
   ...
   changeState()
    ...
    const res=await axios.post(`${TWEET_API_END_POINT}/create`, postData, { withCredentials: true })
    console.log(res)
  }
  return (
