    ...
    <div className='w-[50%] border-l border-r border-gray-300'>
        <div className='w-full'>
            <div className='flex border items-center border-gray-300'>
                ...
                <div className='ml-2'>
                    <h1 className='font-bold text-lg'>Aniket</h1>
                    <p>10 posts</p>
                </div>
            ...
            <div className='text-right m-4'>
                <button className='px-4 py-1 rounded-full  border-[2px] border-gray-500 hover:bg-gray-300'>Edit Profile</button>
            </div>
            <div className='m-4'>
                    <h1 className='font-bold text-xl'>Aniket</h1>
                    <p>@aniketmankar</p>
                    <div>
                      <p>
